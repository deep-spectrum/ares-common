...
#define Z_GENLIST_PEEK_NEXT_CONTAINER(__lname, __cn, __n)                      \
    ((__cn) ? Z_GENLIST_CONTAINER(sys_##__lname##_peek_next(&((__cn)->__n)),   \
                                  __cn, __n)                                   \
            : NULL)
...
#define Z_GENLIST_IS_EMPTY(__lname)                                            \
    static inline bool sys_##__lname##_is_empty(                               \
        const sys_##__lname##_t *list) {                                       \
...
#define Z_GENLIST_PEEK_NEXT(__lname, __nname)                                  \
    static inline sys_##__nname##_t *sys_##__lname##_peek_next(                \
        const sys_##__nname##_t *node) {                                       \
        return (node != NULL) ? sys_##__lname##_peek_next_no_check(node)       \
                              : NULL;                                          \
    }
...
#define Z_GENLIST_APPEND_LIST(__lname, __nname)                                \
    static inline void sys_##__lname##_append_list(sys_##__lname##_t *list,    \
                                                   void *head, void *tail) {   \
...
#define Z_GENLIST_REMOVE(__lname, __nname)                                     \
    static inline void sys_##__lname##_remove(sys_##__lname##_t *list,         \
...
#define Z_GENLIST_FIND(__lname, __nname)                                       \
    static inline bool sys_##__lname##_find(const sys_##__lname##_t *list,     \
                                            const sys_##__nname##_t *node,     \
                                            sys_##__nname##_t **prev) {        \
