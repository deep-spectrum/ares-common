...
#ifndef ARES_ALIGN_ALLOCATOR_HPP
#define ARES_ALIGN_ALLOCATOR_HPP
...
class AlignedAllocator {
  public:
    ...
    [[nodiscard]] static size_type max_size() noexcept {
        return (static_cast<size_type>(~0) - Align) / sizeof(T);
    }
    ...
    allocate(size_type n,
        ...
        const size_type alignment = Align;
